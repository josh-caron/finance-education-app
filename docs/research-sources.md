...
- **Insurance dollar limits.** Congress can change the standard coverage amount. Exercises that need a number state it in the problem (for example, “this problem uses a $250,000 limit”).
